...
class LoraModel(DeltaBase):
    ...
    delta_type = "lora"
    prompt = """
    You are my entity extractor. If I provide OCR-recognized text and ask you for an entity, you must extract and return only a single value of that entity with the unit, if applicable. If the unit is abbreviated, expand it. If no unit is mentioned, leave it blank. If no value is found or a range of values is given, return "err". Do not add anything beyond the requested value.

    OCR text: {} Required entity: {}
    """
